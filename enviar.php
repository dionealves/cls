...
$msg    = "$nome, seus dados foram enviados com sucesso em breve entraremos em contato.";
	...
	<div class="container">
		...
		<div class="row">
			<div class="span12 under-404">
				<h1><?php echo "<p>$nome, sua mensagem foi enviada com sucesso!</p>";
						  echo "<p>Estaremos retornando em breve.</p>" ?></h1>
