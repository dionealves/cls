...
<div id="wrapper">
			...
			<div class="row">
				<div class="span12">
					...
					<ul id="menu" class="visible-desktop">
						...
						<li>
							<a href="index.php">GUIA DE DESCONTOS</a>
							<ul> 
								<li><a href="novaserrana.php">Nova Serrana</a></li>
								<li><a href="belohorizonte.php">Belo Horizonte</a></li>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span8">
				<div class="title"><h2>Bem vindo ao guia virtual da Cartao Líder</h2></div>
				
				<p>O Cartão Líder é uma empresa voltada a oferecer o acesso à saúde através de cartão de descontos que mantém com pessoas físicas e jurídicas prestadoras de serviços em saúde e venda de produtos voltados a prevenção, manutenção e recuperação da saúde.</p>
