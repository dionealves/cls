...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="../index.html">Home</a> / <a href="index.php">Guia de Descontos</a> / <a href="divinopolis.php" class="active">Divinópolis</a></div> 
		</div>
		<div class="row">
			<div class="span4">
				<ul class="navigation"> 
					...
					<li class="active"><a href="divinopolis.php">Divinópolis</a></li>
...
<?
$query_empresas = "select * from tbl_empresas where status = '1' and id_cidade_empresa = '4' order by id_cidade_empresa asc";
