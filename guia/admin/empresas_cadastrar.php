...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Cadastrar Empresas</a></div> 
		</div>
		<div class="row">

			<div class="span4">
				<ul class="navigation"> 
					<li class="active"><a href="empresas_cadastrar.php">Cadastrar</a></li>
			...
			<div class="span8">
				<div class="title"><h2>Cadastro de dados do guia</h2></div>
				<p><strong>Atenção Cássio</strong>, efetue abaixo o cadastro de uma nova empresa:</p>
                <form action="script_empresas.php?acao=cadastrar" Method="post" enctype="multipart/form-data">
                <div class="row">
					<div class="span4">
						<div class="form-padding">
							<label for="titulo">Nome:</label>
							<input type="text" required placeholder="Digite o nome completo" name="titulo" id="titulo" class="form-text" value=""/>
						</div>
					</div>
                    <div class="span4">
						<div class="form-padding">
							<label for="descricao">Descrição:</label>
							<input type="text" required name="descricao" id="descricao" class="form-text" value=""/>
						</div>
					</div>
                    <div class="span4">
						<div class="form-padding">
...
$query="select * from tbl_categorias_empresas order by id_categoria_empresa";
$rs = mysql_query($query);
while($row = mysql_fetch_array($rs)){
$id_categoria_empresa         = $row['id_categoria_empresa'];
$categoria_empresa     = $row['categoria'];

   ?>
                                              <option value="<?echo $id_categoria_empresa; ?>"><?= $categoria_empresa; ?></option>
                                              <?}?>
                           </select>
					...
					<div class="span8">
						<div class="form-padding">
                            ...
                            <textarea name="msg" id="msg" cols="65" rows="15" border='1'></textarea>
						</div>
					</div>
                    <div class="span4">
						<div class="form-padding">
...
$query="select * from tbl_cidades_empresas order by id_cidade_empresa";
$rs = mysql_query($query);
while($row = mysql_fetch_array($rs)){
...
$cidade_empresa     = $row['cidade'];
   ...
   ?>
                                              <option value="<?echo $id_cidade_empresa; ?>"><?= $cidade_empresa; ?></option>
                                              <?}?>
                           </select>
				...
				<div class="row">
                	<div class="span8">
                		<div class="form-padding">
                        	<input name="id_guia" type="hidden" value="<? echo $id_empresa; ?>">
                    		<input type="reset" class="button gray small" value="Limpar" />  
							<input type="submit" class="button blue medium" value="Cadastrar"/>
                    	</div>	
                	</div>	
				</div>
                </form>
