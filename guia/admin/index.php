...
<div id="wrapper">
	...
	<div class="container">
		...
		<div class="row">
			<div class="span12">
				<h1>Administração</h1>
				<span class="under-headline">Faça login para adcionar dados:</span>						
      ...
      <FORM action='inc/autenticacao.rotinas.php' method=post>
      				<div class="row">
						...
						<div class="form-padding">
							...
							<input name='usuario' type="text" required placeholder="Digite seu e-mail" id="f1" class="form-text" value=""/>
						</div>
					</div>
                    </div>
                    <div class="row">
						...
						<div class="form-padding">
							...
							<input type='password' name='senha' placeholder="Digite sua senha" id="f2" class="form-text" value=""/>
                            <div class="span2"><INPUT value="Entrar" name= "Submit" input type="submit" class="button blue medium"/></div>
						</div>
					</div>
                    </div>
