...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php" class="active">Painel de Configuração</a></div> 
		</div>
		<div class="row">
			...
			<div class="span8">
				<div class="title"><h2>Bem vindo ao sistema de cadastro do guia de descontos</h2></div>
				<p><strong>Atenção Cássio</strong>, escolha uma opção:</p>
