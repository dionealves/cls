...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Lista de Categorias</a></div> 
		</div>
		<div class="row">
			...
			<div class="span4">
				<ul class="navigation"> 
					...
					<li class="active"><a href="empresas_categoria_listar.php">Listar Categorias</a></li>
			...
			<div class="span8">
				<div class="title"><h2>Lista de categorias</h2></div>
...
$query = "select * from tbl_categorias_empresas order by id_categoria_empresa desc";
$rs= mysql_query($query);
  ?>
						<div align="center"><strong>Lista de Categorias</strong></div></td>
                    </tr>
                  <tr>
...
while($row = mysql_fetch_array($rs)){
  ?>
                  <tr>
                    <td><?= $row["categoria"] ?></td>
                    <td><div align="center"><a href="empresas_categoria_editar.php?op=editar_categoria&id_categoria_empresa=<?= $row["id_categoria_empresa"] ?>"><img src="imagens/ed_refresh.gif" width="16" height="16" border="0"></a></div></td>
                    <td><div align="center"><a href="script_empresas.php?acao=excluir_categoria&id_categoria_empresa=<?= $row["id_categoria_empresa"] ?>"><img src="imagens/ed_delete.gif" width="18" height="17" border="0"></a></div></td>
                  </tr>
                  <?} ?>
                  </FORM>
                </table>
