...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Edição de Cidades</a></div> 
		</div>
		<div class="row">
			...
			<div class="span4">
				<ul class="navigation"> 
                    ...
                    <li class="active"><a href="#">Editar Cidade</a></li>
					<li><a href="empresas_cidade_listar.php">Listar Cidades</a></li>
                    <li><a href="logout.php">Sair</A></li>
				</ul>
			</div>
			<div class="span8">
				<div class="title"><h2>Edição de Cidade</h2></div>
				<p>Edite o nome da cidade abaixo:</p>
              <div class="row">
              	<FORM name='formident' action="script_empresas.php?acao=editar_cidade" method='post'>
                <div class="span8">
                <?

                    $id_cidade_empresa = $HTTP_GET_VARS['id_cidade_empresa'];

					$query = "select * from tbl_cidades_empresas where id_cidade_noticia = '$id_cidade_empresa'";

					$rs = mysql_query($query);

					while ($campo = mysql_fetch_array($rs)){

					$id_cidade_empresa = $campo['id_cidade_empresa'];
					$cidade            = $campo['cidade'];
				...
				?>
						<div class="form-padding">
							...
							<input type="text" name="cidade" id="cidade" class="form-text" value="<?= $cidade; ?>"/>
                            <input name="id_cidade_empresa" value="<?= $id_cidade_empresa; ?>" type="hidden">
						</div>
				</div>
                <div class="span8">
                		<div class="form-padding">  
