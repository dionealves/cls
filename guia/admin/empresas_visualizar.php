...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Visualizar Cadastro</a></div> 
		</div>
		<div class="row">
			...
			<div class="span4">
				<ul class="navigation"> 
                    ...
                    <li class="active"><a href="#">Visualizar Cadastro</a></li>
...
$status               = $row[status];
  ...
  ?>
				<div class="title"><h2>Cadastro Completo</h2></div>
				<p><strong>Nome:</strong> <?= $titulo_empresa; ?></p>
                <p><strong>Categoria:</strong> <?
                  $query3 = "select categoria from tbl_categorias_empresas where id_categoria_empresa = '$id_categoria_empresa'";
                  $rs3 = mysql_query($query3);
                      while($row3 = mysql_fetch_array($rs3)){
                      $titulo_categoria_empresa     = $row3[categoria];
                      }

                  echo $titulo_categoria_empresa;

                  ?></p>
               <p><strong>Descrição:</strong> <? echo $descricao; ?></p>
               <p><strong>Texto:</strong> <? echo $msg;?></p>
               <p><strong>Situação:</strong> <? if ($ativo != '0'){ echo "Ativo";}else{echo "Inativo";} ?></p>
               <p><strong>Cidade:</strong> <?
                  $query2 = "select cidade from tbl_cidades_empresas where id_cidade_empresa = '$id_cidade_empresa'";
                  $rs2 = mysql_query($query2);
                      while($row2 = mysql_fetch_array($rs2)){
                      $titulo_cidade_empresa     = $row2[cidade];
                      }

                  echo $titulo_cidade_empresa;

                  ?></p>
              <p><strong>Imagem:</strong></p>
              	<div class="thumbnail"> <img src="../imagens/empresas/<? if ($nome_arquivo != ""){echo $nome_arquivo;}else{ echo 'nao_disponivel.jpg';}?>"> 
                  </div>  
              <div class="row">
