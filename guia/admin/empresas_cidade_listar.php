...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Lista de Cidades</a></div> 
		</div>
		<div class="row">
			...
			<div class="span4">
				<ul class="navigation"> 
					...
					<li class="active"><a href="empresas_cidade_listar.php">Listar Cidades</a></li>
                    <li><a href="logout.php">Sair</A></li>
				</ul>
			</div>
			<div class="span8">
				<div class="title"><h2>Lista de cidades</h2></div>
				<p>Lista de cidades cadastradas:</p>
              <div class="row">
              <div class="span8">
                <table class="table table-bordered table-hover" width="100%">
                  <FORM name=formident action="" method=get>
                  <tr>
                    <th colspan="5" scope="col" align="center"> <?
$query = "select * from tbl_cidades_empresas order by id_cidade_empresa desc";
$rs= mysql_query($query);
?>

						<div align="center"><strong>Lista de Cidades</strong></div></th>
                    </tr>
                  <tr>
                    <th width="70%">Cidade</th>
...
while($row = mysql_fetch_array($rs)){
  ?>
                  <tr>
                    <td><?= $row["cidade"] ?></td>
                    <td><div align="center"><a href="empresas_cidade_editar.php?op=editar_cidade&id_cidade_empresa=<?= $row["id_cidade_empresa"] ?>"><img src="imagens/ed_refresh.gif" width="16" height="16" border="0"></a></div></td>
                    <td><div align="center"><a href="script_empresas.php?acao=excluir_cidade&id_cidade_empresa=<?= $row["id_cidade_empresa"] ?>"><img src="imagens/ed_delete.gif" width="18" height="17" border="0"></a></div></td>
                  </tr>
                  <?} ?>
                  </FORM>
                </table>
