...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Cadastro de Cidades</a></div> 
		</div>
		<div class="row">
			...
			<div class="span4">
				<ul class="navigation"> 
					...
					<li class="active"><a href="empresas_cidade_cadastrar.php">Cadastrar Cidades</a></li>
					<li><a href="empresas_cidade_listar.php">Listar Cidades</a></li>
                    <li><a href="logout.php">Sair</A></li>
				</ul>
			</div>
			<div class="span8">
				<div class="title"><h2>Cadastro de Cidade</h2></div>
				<p>Escreva o nome da cidade e click em cadastrar:</p>
                <p>Ex.: Nova Serrana, Belo Horizonte, etc.</p>
              <div class="row">
              	<FORM name='formident' action="script_empresas.php?acao=cadastrar_cidade" method='post'>
                <div class="span8">
						<div class="form-padding">
							<label for="cidade">Cidade:</label>
							<input type="text" required name="cidade" id="cidade" class="form-text" value=""/>
						</div>
				</div>
                <div class="span8">
                		<div class="form-padding">
