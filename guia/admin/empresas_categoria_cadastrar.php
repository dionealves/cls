...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="index.html">Home</a> / <a href="principal.php">Painel de Configuração</a> / <a href="#" class="active">Cadastro de categoria</a></div> 
		</div>
		<div class="row">
			...
			<div class="span4">
				<ul class="navigation"> 
					...
					<li class="active"><a href="empresas_categoria_cadastrar.php">Cadastrar Categoria</a></li>
			...
			<div class="span8">
				<div class="title"><h2>Cadastro de Categoria</h2></div>
				<p>Escreva o nome da categoria e click em cadastrar:</p>
                <p>Ex.: Clínica Geral, Consultório Odontológico, etc.</p>
              <div class="row">
              	<FORM name='formident' action="script_empresas.php?acao=cadastrar_categoria" method='post'>
                <div class="span8">
						<div class="form-padding">
							<label for="categoria">Categoria:</label>
							<input type="text" required name="categoria" id="categoria" class="form-text" value=""/>
						</div>
				</div>
                <div class="span8">
                		<div class="form-padding">
