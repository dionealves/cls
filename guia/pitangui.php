...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="../index.html">Home</a> / <a href="index.php">Guia de Descontos</a> / <a href="pitangui.php" class="active">Pitangui</a></div> 
		</div>
		<div class="row">
			<div class="span4">
				<ul class="navigation"> 
                    ...
                    <li class="active"><a href="pitangui.php">Pitangui</a></li>
				</ul>
			</div>
			<div class="span8">
                
<?
$query_empresas = "select * from tbl_empresas where status = '1' and id_cidade_empresa = '8' order by id_cidade_empresa asc";
