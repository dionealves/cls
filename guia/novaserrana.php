...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="../index.html">Home</a> / <a href="index.php">Guia de Descontos</a> / <a href="novaserrana.php" class="active">Nova Serrana</a></div> 
		</div>
		<div class="row">
			<div class="span4">
				<ul class="navigation"> 
					<li class="active"><a href="novaserrana.php">Nova Serrana</a></li>
...
<?
$query_empresas = "select * from tbl_empresas where status = '1' and id_cidade_empresa = '1' order by id_cidade_empresa asc";
