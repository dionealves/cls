...
<div id="wrapper">
	...
	<div class="container">
		<div id="headline-page" class="hidden-phone hidden-tablet">
			...
			<div id="crumbs"><a href="../index.html">Home</a> / <a href="index.php">Guia de Descontos</a> / <a href="leandroferreira.php" class="active">Leandro Ferreira</a></div> 
		</div>
		<div class="row">
			<div class="span4">
				<ul class="navigation"> 
					<l><a href="novaserrana.php">Nova Serrana</a></li>
					...
					<li class="active"><a href="leandroferreira.php">Leandro Ferreira</a></li>
...
<?
$query_empresas = "select * from tbl_empresas where status = '1' and id_cidade_empresa = '5' order by id_cidade_empresa asc";
